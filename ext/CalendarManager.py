...
class CalendarManager(ttk.LabelFrame):
    ...
    def __init__(self, root):
        ...
        ttk.Label(content, text="Распложение (Y)").grid(row=0, column=0, padx=2, pady=2)
        Spinbox(content, from_=1, to=1000, increment=1, width=5, textvariable=self._posValue).grid(row=0, column=1, padx=2, pady=2)
