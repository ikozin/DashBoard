...
class OpenWeatherMapManager(BaseManager):
    ...
    def load(self, config, module_list):
        ...
        self._key_value.set(section.get("Key", ""))
        ...
        font_name = section.get("WeatherTypeFontName", "Helvetica")
        font_size = section.getint("WeatherTypeFontSize", 64)
        is_bold = section.getboolean("WeatherTypeFontBold", True)
        is_italic = section.getboolean("WeatherTypeFontItalic", False)
        self._weather_type.load(font_name, font_size, is_bold, is_italic)

        font_name = section.get("TemperatureFontName", "Helvetica")
        font_size = section.getint("TemperatureFontSize", 160)
        is_bold = section.getboolean("TemperatureFontBold", True)
        is_italic = section.getboolean("TemperatureFontItalic", False)
        self._temperature.load(font_name, font_size, is_bold, is_italic)

        font_name = section.get("HumidityFontName", "Helvetica")
        font_size = section.getint("HumidityFontSize", 64)
        is_bold = section.getboolean("HumidityFontBold", False)
        is_italic = section.getboolean("HumidityFontItalic", False)
        self._humidity.load(font_name, font_size, is_bold, is_italic)

        font_name = section.get("PressureFontName", "Helvetica")
        font_size = section.getint("PressureFontSize", 64)
        is_bold = section.getboolean("PressureFontBold", False)
        is_italic = section.getboolean("PressureFontItalic", False)
